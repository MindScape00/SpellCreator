...
gossipAddMenuInsert.RadioCast.text:SetText("Cast Spell from Phase")
...
gossipAddMenuInsert.RadioCast:SetPoint("TOPLEFT", 0, 0)
...
gossipAddMenuInsert.RadioCast:SetScript("OnEnter", function(self)
	GameTooltip:SetOwner(self, "ANCHOR_LEFT")
	self.Timer = C_Timer.NewTimer(0.7,function()
		GameTooltip:SetText("Cast Spell from Phase", nil, nil, nil, nil, true)
		GameTooltip:AddLine("\nCasts the specificed spell from the Phase Vault, to the Personal Vault.",1,1,1,true)
		GameTooltip:Show()
	end)
end)
...
gossipAddMenuInsert.RadioSave.text:SetText("Save Spell from Phase")
...
gossipAddMenuInsert.RadioSave:SetScript("OnEnter", function(self)
	...
	self.Timer = C_Timer.NewTimer(0.7,function()
		...
		GameTooltip:AddLine("\nSaves the spell, from the Phase Vault, to the Personal Vault.",1,1,1,true)
		GameTooltip:Show()
	end)
end)
			...
			button:SetScript("OnClick", function(self, button)
				StaticPopupDialogs["SCFORGE_ADD_GOSSIP"] = {
					...
					OnButton1 = function(self, data)
						...
						local tag = "<arc_"..(function() if self.insertedFrame.RadioCast:GetChecked() then return "cast"; elseif self.insertedFrame.RadioSave:GetChecked() then return "save"; end end)
