...
local altPowerBars = {
	...
	["sanctum-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/sanctum-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = true;
	...
	["warden-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/warden-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["archer-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/archer-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["mana-gems-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/mana-gems-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["phoenix-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/phoenix-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["holy-power-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/holy-power-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = false;
	...
	["balance-bar"] = {
		path = "Interface/AddOns/SpellCreator/assets/UnitPowerBar/balance-bar_";
		frame = false;
		background = true;
		fill = true;
		spark = true;
