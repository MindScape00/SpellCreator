...
function SCForgeTalkingHeadFrame_SetUnit(displayID, name, textureKit, message, sound, chatType, timeout)
	...
	if textureKit == "Epsilon" then
		...
		frame.BackgroundFrame.TextBackground:SetTexture("Interface/AddOns/SpellCreator/assets/TalkingHeads");
		...
		frame.PortraitFrame.Portrait:SetTexture("Interface/AddOns/SpellCreator/assets/TalkingHeads");
